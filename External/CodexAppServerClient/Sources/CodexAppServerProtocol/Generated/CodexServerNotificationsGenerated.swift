...
extension ServerNotifications {
    ...
    ///
    /// Wire method: `thread/realtime/transcript/delta`.
    public enum ThreadRealtimeTranscriptDelta: CodexServerNotificationMethod {
        public typealias Params = ThreadRealtimeTranscriptDeltaNotification
        public static let method = NotificationMethod.threadRealtimeTranscriptDelta
    }

    /// EXPERIMENTAL - final transcript text emitted when realtime completes a transcript part.
    ///
    /// Wire method: `thread/realtime/transcript/done`.
    public enum ThreadRealtimeTranscriptDone: CodexServerNotificationMethod {
        public typealias Params = ThreadRealtimeTranscriptDoneNotification
        public static let method = NotificationMethod.threadRealtimeTranscriptDone
    }
...
extension ServerNotifications {
    public static let all: [any CodexServerNotificationMethod.Type] = [
        ...
        ServerNotifications.ThreadRealtimeTranscriptDelta.self,
        ServerNotifications.ThreadRealtimeTranscriptDone.self,
...
public enum ServerNotificationEvent: Sendable {
    ...
    public var method: NotificationMethod {
        ...
        case .threadRealtimeTranscriptDelta: return .threadRealtimeTranscriptDelta
        case .threadRealtimeTranscriptDone: return .threadRealtimeTranscriptDone
    ...
    public init(from data: Data, decoder: JSONDecoder) throws {
        ...
        case .threadRealtimeTranscriptDelta:
            self = .threadRealtimeTranscriptDelta(try decoder.decode(_ServerNotificationPayload<ThreadRealtimeTranscriptDeltaNotification>.self, from: data).params)
        case .threadRealtimeTranscriptDone:
            self = .threadRealtimeTranscriptDone(try decoder.decode(_ServerNotificationPayload<ThreadRealtimeTranscriptDoneNotification>.self, from: data).params)
        case .threadStarted:
...
extension ServerNotificationEvent {
    ...
    public func params<Method: CodexServerNotificationMethod>(
        ...
        case .threadRealtimeTranscriptDelta(let payload): return payload as? Method.Params
        case .threadRealtimeTranscriptDone(let payload): return payload as? Method.Params
    ...
    public var threadId: String? {
        ...
        case .threadRealtimeTranscriptDelta(let p): return p.threadId
        case .threadRealtimeTranscriptDone(let p): return p.threadId
    ...
    public var turnId: String? {
        ...
        case .threadRealtimeTranscriptDelta: return nil
        case .threadRealtimeTranscriptDone: return nil
